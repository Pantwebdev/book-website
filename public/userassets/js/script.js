 ...
 function closePopup() {
  ...
  window.changeQty = function(amount) {
    ...
    if (qty > productStock) {
       ...
       "  Only " + productStock + " items available";

        // Optional: disable + button
        document.querySelectorAll('.qty-btn')[1].disabled = true;
    } else {
        // enable button again if valid
        document.querySelectorAll('.qty-btn')[1].disabled = false;
    }
...
=============================================================== */
document.addEventListener("DOMContentLoaded", function() {
  // Check if review elements exist
