   ...
   <div class="container-fluide">
       <div class="page-inner">
           <div class="page-header">
               <h3 class="fw-bold mb-3">Page Forms</h3>
           ...
           <div class="row">
               <div class="col-md-12">
                   <div class="card">
                       ...
                       <h3 class="fw-bold mb-3">Page Table</h3>
                       ...
                       <div class="card">
                           ...
                           <div class="card-body">
                               ...
                               <div class="table-responsive">
                                   <table id="page-table" class="display table table-striped table-hover">
    <thead>
        <tr>
            <th>Id</th>
            <th>Title</th>
...
$(document).ready(function() {
    $('.toggle-status').click(function() {
        ...
        $.ajax({
            url: '/admin/page/status-toggle/' + id,
            method: 'GET',
